...
public class ProceduresActivity extends AppCompatActivity implements View.OnClickListener
{
        ...
        db.collection("Patient").document(UID.getUid()).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful())
                {
                    ...
                    if (document.exists())
                    {
                        if (document.getData().containsKey("procedures"))
                        {
                            Log.e("EXIST","TESTS");
                            String all = String.valueOf(document.getData().get("procedures"));
    ...
    public void onClick(View v)
    {
        ...
        {
            case R.id.back:
                Intent intent = new Intent(ProceduresActivity.this, HomeActivity.class);
