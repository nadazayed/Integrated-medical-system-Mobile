...
import com.example.myapplication.helper.GetNearbyPlaces;
...
public class GoogleMapsActivity extends FragmentActivity implements
    ...
    public void onClick(View v)
    {
        ...
        {
            case R.id.search:
                String address = ((EditText) findViewById(R.id.location_search)).getText().toString();
            ...
            case R.id.refresh:
                ...
                Toast.makeText(this,"Loading nearby medical centers..",Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    private String getUrl (double latitude, double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyDf9za7Hfo4oHXLws70A4CI-nFY2bY9638");

        Log.d("GoogleMaps","url= "+googleURL.toString());
